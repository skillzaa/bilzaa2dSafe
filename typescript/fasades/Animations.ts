...
moveHorizontal(fromSecond=1,toSecond=5,from=1,to=100){
    const l = new Linear(
        {attributeToAnimateName: "x",fromSecond:fromSecond, toSecond:toSecond},[],{from:from, to:to});
    this.data.push(l);    
    return true;
}
// //---------------------------------
moveVerticle(fromSecond=1,toSecond=5,from=1,to=100){
    const l = new Linear(
        {attributeToAnimateName: "y",fromSecond:fromSecond, toSecond:toSecond},[],{from:from, to:to});
    this.data.push(l);    
    return true;    
}
// //---------------------------------
...
widen(fromSecond,toSecond,from,to){
    const l = new Linear(
        {attributeToAnimateName: "width",fromSecond:fromSecond, toSecond:toSecond},[],{from:from, to:to});
    this.data.push(l);    
    return true;    
}
heighten(fromSecond,toSecond,from,to){
    const l = new Linear(
        {attributeToAnimateName: "height",fromSecond:fromSecond, toSecond:toSecond},[],{from:from, to:to});
    this.data.push(l);    
    return true;    
}
scale(fromSecond,toSecond,fromWidth,toWidth,fromHeight,toHeight){
    const w = new Linear(
        {attributeToAnimateName: "width",fromSecond:fromSecond, toSecond:toSecond},[],{from:fromWidth, to:toWidth});
    this.data.push(w);    
//----------------------------
    const h = new Linear(
        {attributeToAnimateName: "height",fromSecond:fromSecond, toSecond:toSecond},[],{from:fromHeight, to:toHeight});
    this.data.push(h);    
    return true;    
}
rotate(fromSecond, toSecond,from,to){
    const w = new Linear(
        {attributeToAnimateName: "rotateAngle",fromSecond:fromSecond, toSecond:toSecond},[],{from:from, to:to});
    this.data.push(w);    
    return true;
}
//---------------------------------

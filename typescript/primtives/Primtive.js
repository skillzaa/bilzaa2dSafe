...
var Primtive = /** @class */ (function () {
    function Primtive(name) {
    ...
    Primtive.prototype.setNextFrame = function (currentSecond) {
        var _this = this;
        this.clearCanvas();
        //==================LLLLLOOOOPPPPP======================== 
    ...
    Primtive.prototype.draw = function () {
    };
    Primtive.prototype.clearCanvas = function () {
